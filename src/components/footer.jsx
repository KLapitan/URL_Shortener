 ...
 <footer className="h-auto ">
    <section className="h-auto w-full  bg-NGray950 flex flex-col justify-center items-center px-6 py-12 font-Poppins lg:flex-row lg:items-start lg:justify-evenly lg:gap-10 2xl:gap-0 ">
